            ...
            <div className="space-y-6">
              {education.map((edu) => {
                ...
                const gradientColors = {
                  'from-green-300 to-yellow-400': 'from-green-300 to-yellow-400',
                  'from-blue-700 to-amber-500': 'from-blue-700 to-amber-500',
                };
                const gradientClass = gradientColors[edu.gradientClass] || edu.gradientClass;
                
                return (
                  <div key={edu.id} className="relative group">
                    <div className={`relative bg-black rounded-xl p-6 space-y-3 border-2 border-gray-800 transition-all duration-300 group-hover:scale-105 education-card-hover`}
